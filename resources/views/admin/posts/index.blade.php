<x-layouts.app>
    <div class="mb-4 flex justify-between items-center" >
        ...
        <a href="{{route('admin.posts.create')}}" class="btn btn-blue">+</a>    
    </div>
    <div class="relative overflow-x-auto mb-4">
        <table id="posts-table" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#posts-table').DataTable({
                ...
                ordering: true,
                columnDefs: [
                    { orderable: false, targets: 2 } // La columna 2 (índice 2) no será ordenable
                ],
                language: {
